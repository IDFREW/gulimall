package com.ex20.gulimall.member.controller;

import java.util.Arrays;
import java.util.Map;

import com.ex20.gulimall.member.feign.CouponFeignService;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.cloud.context.config.annotation.RefreshScope;
import org.springframework.web.bind.annotation.*;

import com.ex20.gulimall.member.entity.GrowthChangeHistoryEntity;
import com.ex20.gulimall.member.service.GrowthChangeHistoryService;
...
public class GrowthChangeHistoryController {
    ...
    @GetMapping("/configs")
    public R couponConfigs(){
        return couponFeignService.configText();
    }
